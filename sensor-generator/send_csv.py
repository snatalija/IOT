...
def map_row(r: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "orderId":          str(pick("Order ID", "order_id", "OrderID", "Order_ID", default="AMZ-NA")),
        "deliveryPersonId": str(pick("Delivery Person ID", "delivery_person_id", "Person ID", "person_id", default="D-NA")),
        "city":             str(pick("City", "city", "Customer City", default="NA")),
        "weather":          str(pick("Weather", "weather", default="Unknown")),
        "traffic":          str(pick("Traffic", "traffic", default="Unknown")),
        "distanceKm": float(pick("Distance (KM)", "Distance KM", "distance_km", "DistanceKm", default=0.0) or 0.0),
        "timeTakenMin": float(pick("Time Taken (min)", "Time Taken Min", "time_taken_min", "TimeTakenMin", default=0.0) or 0.0),
        "deliveryTimestamp": to_iso(pick("Delivery Time", "delivery_timestamp", "Delivered Time")),
